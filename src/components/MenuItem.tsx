...
export function MenuItem({highlight,titre,libelle,prix,ingredient}:element){
    ...
    return(
        <>
            <div className={clsx( {
                ...
                {titre && (<div className="text-white text-4xl  font-bold pl-3 text-center lg:text-left py-4"> {titre}</div>)}
                ...
                <div className="p-4 ">
                    <div className="flex flex-row justify-between py-3">
                        ...
                        <div className="text-[#ca9c5e] font-bold text-3xl ml-2">
                            {prix} CFA
                        </div>
                    </div>
